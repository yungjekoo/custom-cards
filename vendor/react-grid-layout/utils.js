...
var utils = window.ReactGridLayoutUtils = {
  ...
  synchronizeLayoutWithChildren: function synchronizeLayoutWithChildren(initialLayout, children, cols, verticalCompact) {
    ...
    for (var i = 0, len = children.length; i < len; i++) {
      ...
      if (g) {
        ...
        if (verticalCompact) {
          layout.push(Object.assign({}, g, { y: Math.min(utils.bottom(layout), g.y), i: child.key }));
        } else {
          layout.push(Object.assign({}, g, { y: g.y, i: child.key }));
        }
      } else {
